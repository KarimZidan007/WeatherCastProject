...
data class FullWeatherDetails(var temp:String, var minTemp:String, var maxTemp:String, var pressure:String, var humidity:String, var windSpeed:String,  var cityName: String,var address:String,var country:String, var desc:String, var icon:String, var latitude :Double =0.0, var longitude:Double =0.0, var weatherForecast:List<ForecastFinal> ):
    Parcelable {
